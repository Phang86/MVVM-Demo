...
import com.gy.mvvm_demo.databinding.DialogWeatherBinding;
import com.gy.mvvm_demo.databinding.FragmentMapBinding;
import com.gy.mvvm_demo.model.LiveWeather;
import com.gy.mvvm_demo.ui.adapter.CityAdapter;
import com.gy.mvvm_demo.ui.adapter.ForecastAdapter;
import com.gy.mvvm_demo.viewmodels.MapViewModel;
...
public class MapFragment extends BaseFragment implements AMap.OnMyLocationChangeListener, GeocodeSearch.OnGeocodeSearchListener, WeatherSearch.OnWeatherSearchListener, DistrictSearch.OnDistrictSearchListener {
    ...
    //天气预报列表
    private List<LocalDayWeatherForecast> weatherForecast = new ArrayList<>();
    //地区搜索
...
//        dialog.getWindow().setBackgroundDrawable(R.drawable);
        //弹窗关闭时显示浮动按钮
